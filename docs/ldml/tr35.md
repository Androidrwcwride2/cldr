...
<tr><td>"cu"<br>(currency)</td>
    ...
    <td><p>Well-formed codes are of the form <code>[A-Za-z]{3}</code>, with the canonical format being <code>[A-Z]{3}</code>. 
	    ...
	    <a href="tr35-numbers.md#Supplemental_Currency_Data">Supplemental Currency Data</a> provides the list of countries and time periods associated with each currency code. 
